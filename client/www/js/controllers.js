...
.controller('LoginCtrl', function ($scope, User, $ionicPopup, $ionicHistory, $state) {
    ...
    /*
    $scope.register = function () {
        User.register($scope.user.name, $scope.user.password).then(function () {
            $ionicHistroy.nextViewOptions({
                disableBack: true
            });
            $state.go('register');
        }).catch(function () {
...
////////////////////////why I cannot go to register.html...??!
.controller('registerCtrl',function ($scope, User, $ionicPopup, $ionicHistory, $state){
...
.controller('LikeCtrl', function ($scope, $rootScope, $location, API) {
